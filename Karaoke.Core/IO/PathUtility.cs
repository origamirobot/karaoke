namespace Karaoke.Core.IO
{
    ...
    public class PathUtility : IPathUtility
    {
        ...
        /// </returns>
        public Boolean HasExtension(String path) => Path.HasExtension(path);
        ...
        /// </returns>
        public Boolean IsPathRooted(String path) => Path.IsPathRooted(path);

    }


    /// <summary>
    /// Defines an interface that all PathUtility classes must implement. Acts as a wrapper around the <see cref="System.IO.Path"/> class for testability.
    /// </summary>
